...
protocol PurchaseListRouterInput{
    func navigateToSomewhere()
}

class PurchaseListRouter: PurchaseListRouterInput{
    weak var viewController: PurchaseListViewController!
